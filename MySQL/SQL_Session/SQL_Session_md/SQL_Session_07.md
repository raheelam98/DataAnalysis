...
**Correlated Subqueries, Window Functions & Common Table Expressions (CTEs)**

---

### SQL Session 07 Questions
...
1. Retrieve the first order (earliest order date) for each customer.

### Window Functions – Aggregate

2. Calculate the total number of orders placed by each customer.  
3. Show item details with item count and average price per item type.  
4. Show a running total of item prices based on order date.

### Window Functions – LAG & LEAD

5. Show the previous order date for each customer using `LAG()`.  
6. Show the next order date for each customer using `LEAD()`.  
7. Show the number of days between the first and second order per customer.

### Row Number, Rank, Dense Rank

8. Assign row numbers for customers partitioned by city.  
9. Assign row numbers to items per item ty

```

---

### SQL Session 07 Questions with Answers
